...
Investigar as experiências, emoções, frustrações e necessidades dos usuários diretamente afetados pelo problema social que será enfrentado.
...
- **Frase estruturada**:
  ...
  > "[Usuário] precisa de [necessidade] porque [justificativa]."
